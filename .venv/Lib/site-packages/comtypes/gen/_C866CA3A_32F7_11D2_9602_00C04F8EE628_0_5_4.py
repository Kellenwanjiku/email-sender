...
__all__ = [
    ...
    'SREStreamStart', 'DISPID_SPRuleName', 'DISPID_SLGenerationId',
    'SINone', 'DISPID_SPRuleEngineConfidence', 'ISpEventSource',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SAFTExtendedAudioFormat',
    'SPEI_RESERVED1', 'eLEXTYPE_PRIVATE12', 'SpInprocRecognizer',
    'ISpeechMMSysAudio', 'SPSHT_EMAIL', 'SVPNormal',
    'ISpeechGrammarRuleStateTransition', 'SP_VISEME_1',
    'SAFTCCITT_ALaw_22kHzStereo', 'SVSFParseSapi', 'SPEI_SOUND_START',
    'eLEXTYPE_PRIVATE19', 'DISPID_SpeechObjectTokens',
    '_SPAUDIOSTATE', 'DISPID_SGRSTPropertyName', 'ISpeechGrammarRule',
    'SRATopLevel', 'DISPID_SLWPronunciations',
    'DISPID_SPRNumberOfElements', 'ISpeechObjectToken', 'SpMMAudioIn',
    'DISPID_SPRsItem', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SVAlertBoundary', 'DISPID_SpeechVoiceEvent',
    'DISPID_SRRSaveToMemory', 'SPEI_RECO_STATE_CHANGE',
    'SpeechTokenKeyUI', 'SECHighConfidence', 'SP_VISEME_11',
    ...
    'SPRS_ACTIVE_USER_DELIMITED', 'SGSExclusive', 'SP_VISEME_7',
    'SPWF_INPUT', 'eLEXTYPE_PRIVATE16', 'DISPID_SPIRule',
    'SAFT16kHz8BitStereo', 'DISPID_SRSCurrentStreamNumber',
    'SAFT48kHz16BitMono', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SPPId', 'DISPID_SRCVoice', 'SPVPRIORITY',
    'DISPID_SPRules_NewEnum', 'eLEXTYPE_USER_SHORTCUT',
    'eLEXTYPE_PRIVATE1', 'SAFT11kHz16BitStereo',
    'DISPID_SpeechPhraseInfo', 'DISPID_SAEventHandle',
    'DISPID_SMSADeviceId', 'SVF_Stressed', 'SPWT_LEXICAL',
    'DISPID_SPIStartTime', 'SpeechStreamFileMode', 'SVP_11',
    'SGSEnabled', 'SP_VISEME_17', 'SFTInput', 'SPLO_STATIC',
    'SECFNoSpecialChars', 'DISPID_SRGCommit', 'SpeechAudioState',
    'SRAInterpreter', 'SPSFunction', 'DISPID_SRIsUISupported',
    'SpSharedRecognizer', 'SRSActive', 'DISPID_SPIEnginePrivateData',
    'SREFalseRecognition', 'SPPS_RESERVED2', 'SDTReplacement',
    'SAFT12kHz8BitStereo', 'SVEViseme',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SpeechVoiceCategoryTTSRate', 'SPSERIALIZEDRESULT', 'SVF_None',
    'ISpeechPhraseInfo', 'DISPID_SRState', 'STCAll', 'SPWF_SRENGINE',
    'SPSInterjection', 'SREAllEvents', 'DISPID_SDKEnumKeys',
    'SREStateChange', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SPRText', 'ISpeechAudioFormat',
    'ISpeechPhraseInfoBuilder', 'ISpNotifySink', 'SLODynamic',
    'DISPID_SpeechRecoResult', 'SWTDeleted', 'SAFTADPCM_11kHzMono',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpeechAudioStatus', 'SPAUDIOBUFFERINFO',
    'DISPID_SRCEAdaptation', 'SAFTNonStandardFormat',
    'SpPhoneticAlphabetConverter', 'SAFT11kHz16BitMono',
    'DISPID_SRCState', 'DISPID_SVRate', 'SVP_13',
    'DISPID_SRGCmdLoadFromResource', 'eLEXTYPE_PRIVATE6',
    'SAFTADPCM_44kHzMono', 'DISPID_SOTCSetId', 'SpeechRuleAttributes',
    'SPEI_MAX_SR', 'SpeechCategoryVoices', 'SpPhoneConverter',
    ...
    'DISPID_SPIEngineId', 'SVSFParseSsml', 'DISPID_SpeechVoiceStatus',
    'DISPID_SLAddPronunciationByPhoneIds', 'SREInterference',
    'SPSHT_OTHER', 'tagSPTEXTSELECTIONINFO', 'DISPID_SVEStreamEnd',
    'DISPID_SPAPhraseInfo', 'DISPID_SVSInputWordPosition',
    'ISpeechPhraseProperty', 'SpAudioFormat', 'SAFT8kHz8BitMono',
    'SAFT22kHz8BitStereo', 'SAFTCCITT_ALaw_44kHzStereo',
    'ISpeechFileStream', 'SVP_12', 'SPBINARYGRAMMAR',
    'DISPID_SOTCategory', 'SITooFast', 'ISpAudio', 'SASClosed',
    'DISPID_SRCEPropertyNumberChange', 'SPEVENTSOURCEINFO',
    'DISPID_SGRSAddRuleTransition', 'SpObjectTokenCategory',
    'SAFTTrueSpeech_8kHz1BitMono', 'ISpeechRecoResult',
    'SPVPRI_NORMAL', 'SPAR_Medium',
    'SpeechGrammarRuleStateTransitionType', 'SpStream',
    'SPSHORTCUTTYPE', 'SPPS_Interjection', 'DISPID_SOTCDefault',
    'DISPID_SLPsItem', 'SAFT32kHz16BitMono', 'DISPID_SVWaitUntilDone',
    'SRAExport', 'SGDisplay', 'DISPID_SRCSetAdaptationData',
    'IInternetSecurityMgrSite', 'SASPause',
    'SPRST_INACTIVE_WITH_PURGE', 'SSTTWildcard', 'DISPID_SPEsItem',
    'DISPID_SVSPhonemeId', 'DISPID_SVEPhoneme',
    'DISPID_SRGCmdLoadFromObject', 'SVP_18', 'SPRULE',
    'DISPID_SVGetAudioInputs', 'DISPID_SRGDictationLoad',
    'SPEI_VISEME', 'DISPID_SDKGetBinaryValue',
    'DISPID_SRSAudioStatus', 'SP_VISEME_14', 'SPEI_WORD_BOUNDARY',
    'DISPID_SASCurrentDevicePosition', 'SVP_8', 'SVSFNLPMask',
    'DISPID_SADefaultFormat', 'DISPID_SpeechMMSysAudio',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SPRuleParent',
    'DISPID_SpeechRecoContextEvents', 'SPCATEGORYTYPE',
    'DISPID_SRRPhraseInfo', 'DISPID_SDKOpenKey', 'SPRECORESULTTIMES',
    'SpeechRunState', 'DISPID_SLWWord', 'DISPID_SDKCreateKey',
    'SPBOOKMARKOPTIONS', 'SpInProcRecoContext', 'SPSVerb',
    'SVEAllEvents', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SpeechAudio', 'SPVISEMES', 'SPFM_CREATE_ALWAYS',
    'SpeechPropertyHighConfidenceThreshold', 'SVEEndInputStream',
    'DISPID_SRRTLength', 'SPWORDPRONUNCIATION',
    'DISPID_SPEAudioSizeTime', 'DISPID_SRCreateRecoContext',
    'SPFILEMODE', 'DISPID_SGRSTransitions',
    'SPINTERFERENCE_LATENCY_WARNING', 'SpeechPropertyResourceUsage',
    'SDTDisplayText', 'DISPID_SpeechPhraseBuilder',
    'SAFT44kHz8BitMono', 'SPAS_RUN', 'DISPID_SRRAlternates',
    'SSSPTRelativeToCurrentPosition', 'SPSLMA', 'SINoise',
    'DISPID_SRCESoundStart', 'SRTEmulated',
    'DISPID_SRGSetTextSelection', 'SpWaveFormatEx',
    'DISPID_SMSGetData', 'SPPROPERTYINFO', 'SPEI_SR_PRIVATE',
    'SAFT8kHz16BitMono', 'SGDSActive', 'DISPID_SRRRecoContext',
    'DISPID_SGRAddState', 'SDTAll', 'WAVEFORMATEX',
    'DISPID_SLPsCount', 'eLEXTYPE_PRIVATE5',
    'DISPID_SLAddPronunciation', 'SpeechDictationTopicSpelling',
    'SAFT22kHz8BitMono', 'DISPID_SBSSeek',
    'ISpeechGrammarRuleStateTransitions', 'SP_VISEME_20',
    'SDA_No_Trailing_Space', 'SPINTERFERENCE_TOOSLOW', 'SRESoundEnd',
    'SASRun', 'SAFT16kHz16BitMono', 'SRSEIsSpeaking',
    'SpStreamFormatConverter', 'SpeechPartOfSpeech',
    ...
    'SPGRAMMARWORDTYPE', 'DISPID_SLPPartOfSpeech', 'SVSFDefault',
    'DISPID_SPILanguageId', 'ISpeechLexiconPronunciations', 'SVPOver',
    ...
    'DISPID_SLGetWords', 'eLEXTYPE_PRIVATE4',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRGetPropertyString',
    'SAFTGSM610_8kHzMono', 'SPADAPTATIONRELEVANCE', 'DISPID_SRRAudio',
    'SDKLDefaultLocation', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'ISpDataKey', 'SP_VISEME_21', 'DISPID_SPPChildren',
    'ISpeechAudioBufferInfo', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SVAudioOutputStream', 'ISpProperties', 'SPCS_DISABLED',
    'DISPID_SPRs_NewEnum', 'SPFM_CREATE', 'SPPS_RESERVED3',
    'DISPID_SVEAudioLevel', 'SPEI_TTS_PRIVATE',
    'DISPID_SOTRemoveStorageFileName', 'ISpRecoCategory',
    'ISpeechObjectTokenCategory', 'DISPID_SASFreeBufferSpace',
    'DISPID_SGRSTNextState', 'eLEXTYPE_PRIVATE14', 'SpeechRecoEvents',
    'SSFMCreate', 'SRCS_Disabled', 'SPCT_COMMAND',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPRECOGNIZERSTATUS',
    'SP_VISEME_2', 'SRAImport', 'SPWORDTYPE', 'SP_VISEME_10',
    'eWORDTYPE_ADDED', 'DISPID_SpeechObjectToken',
    'DISPID_SPIReplacements', 'SPXRO_SML', 'SPDKL_LocalMachine',
    'SRAORetainAudio', 'ISpNotifySource', 'SVSFlagsAsync',
    'STCLocalServer', 'SPPHRASE', 'DISPID_SGRName',
    'DISPID_SVSLastResult', 'STSF_CommonAppData',
    'SPRST_ACTIVE_ALWAYS', 'SDA_Two_Trailing_Spaces',
    'DISPID_SPRFirstElement', 'SFTSREngine', 'ISpObjectToken',
    'SWPKnownWordPronounceable', 'DISPID_SWFEBlockAlign',
    'DISPID_SVSRunningState', 'SGPronounciation',
    'DISPID_SVEStreamStart', 'SRESoundStart', 'SPEI_RECOGNITION',
    'SAFTADPCM_22kHzStereo', 'DISPID_SRGState', 'SVP_16', 'SVP_4',
    'SPAR_Low', 'SpeechBookmarkOptions', 'DISPID_SVEventInterests',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRGCmdSetRuleIdState',
    'SpeechPropertyResponseSpeed', 'DISPID_SRGCmdLoadFromMemory',
    'SP_VISEME_3', 'SRERecognition',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SPISaveToMemory',
    'DISPID_SpeechBaseStream', 'SPEI_TTS_BOOKMARK',
    'SECFIgnoreKanaType', 'DISPID_SRRTOffsetFromStart',
    'Speech_StreamPos_Asap', 'DISPID_SBSFormat', 'SVP_20',
    'SpCustomStream', 'eLEXTYPE_PRIVATE20', 'STSF_FlagCreate',
    'SPAS_STOP', 'DISPID_SpeechLexiconProns', 'ISpSerializeState',
    'DISPID_SASNonBlockingIO', 'DISPID_SPCPhoneToId',
    'DISPID_SpeechGrammarRuleState', 'SpMMAudioOut',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SPAStartElementInResult',
    'DISPID_SVEViseme', 'DISPID_SRCCreateGrammar', 'SVSFIsXML',
    'SPAUDIOSTATUS', 'SRADynamic', 'SpeechCategoryAudioIn',
    'DISPID_SPEDisplayText', 'DISPID_SGRInitialState',
    'DISPID_SGRsItem', 'ISpeechBaseStream',
    'DISPID_SVSInputSentencePosition', 'SPEI_HYPOTHESIS',
    'SPRST_INACTIVE', 'DISPID_SOTSetId', 'eLEXTYPE_PRIVATE2',
    'UINT_PTR', 'DISPID_SVESentenceBoundary', 'SPLEXICONTYPE',
    'ISpeechResourceLoader', 'DISPID_SVSLastBookmark', 'LONG_PTR',
    'ISpStream', 'DISPID_SPRulesCount', 'DISPID_SGRsFindRule',
    'DISPID_SGRAddResource', 'SPSMF_UPS', 'ISpeechPhraseAlternate',
    'SPEI_END_INPUT_STREAM', 'DISPID_SRRAudioFormat',
    'DISPID_SRProfile', 'DISPID_SWFESamplesPerSec',
    'SVESentenceBoundary', 'SPVPRI_OVER',
    'DISPID_SRCERecognizerStateChange', 'SDKLCurrentConfig',
    'DISPID_SRDisplayUI', 'DISPID_SRCCmdMaxAlternates',
    'eLEXTYPE_APP', 'SpeechAudioFormatGUIDText',
    'SPXRO_Alternates_SML', 'DISPID_SVSpeak', 'SAFT12kHz16BitStereo',
    'eLEXTYPE_MORPHOLOGY', 'ISpObjectWithToken', 'tagSPPROPERTYINFO',
    'DISPID_SAStatus', 'DISPID_SpeechLexiconWords', 'SVEPrivate',
    'DISPID_SRRTStreamTime', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SPIAudioSizeTime', 'DISPID_SDKSetStringValue',
    'DISPID_SPEActualConfidence', 'DISPID_SRCBookmark',
    'SPGS_ENABLED', 'SGRSTTWord',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SpeechPhraseRules', 'SVSFVoiceMask', 'SRADefaultToActive',
    'DISPID_SABIBufferSize', 'DISPID_SRSCurrentStreamPosition',
    'SPRS_INACTIVE', 'DISPID_SpeechWaveFormatEx', 'SpeechWordType',
    'SpShortcut', 'SpeechGrammarTagDictation',
    'DISPID_SRCEHypothesis', 'SPPS_Unknown', 'SRERequestUI',
    'DISPID_SRSetPropertyNumber', 'ISpRecoContext2',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SVSInputSentenceLength', 'SpeechLexiconType',
    'SpeechAudioFormatGUIDWave', 'SAFTNoAssignedFormat',
    'ISpeechPhraseProperties', 'SPAR_High', '_ISpeechVoiceEvents',
    'SpeechAudioProperties', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SBSWrite', 'SVP_3', 'DISPID_SPEPronunciation',
    ...
    'SPINTERFERENCE', 'DISPID_SGRSTType', 'SAFTCCITT_uLaw_44kHzMono',
    ...
    'DISPID_SPPEngineConfidence', 'SGRSTTTextBuffer',
    'SVSFIsFilename', 'SPSUnknown', 'SP_VISEME_6', 'SPSSuppressWord',
    'SRCS_Enabled', 'SP_VISEME_9', 'SPEI_INTERFERENCE',
    'SpeechSpecialTransitionType', 'IInternetSecurityManager',
    'ISequentialStream', 'SAFT24kHz16BitMono', 'SPSNotOverriden',
    'SASStop', 'SpeechCategoryPhoneConverters', 'DISPID_SRCResume',
    'SVP_1', 'SPSMF_SAPI_PROPERTIES', 'SECFIgnoreWidth',
    'DISPID_SOTIsUISupported', 'SVP_5', 'DISPID_SPARecoResult',
    'SpeechPropertyLowConfidenceThreshold', 'SPINTERFERENCE_TOOFAST',
    'ISpPhraseAlt', 'SPAR_Unknown', 'DISPID_SDKDeleteValue',
    'DISPID_SRCEBookmark', 'SpeechPropertyAdaptationOn',
    'ISpeechRecoResult2', 'SpeechLoadOption', 'DISPID_SGRsCount',
    'DISPID_SABIMinNotification', 'SPPS_Verb', 'SPSHT_Unknown',
    'DISPID_SOTGetAttribute', 'SREPropertyStringChange',
    'DISPID_SRCRetainedAudio', 'DISPID_SRRSetTextFeedback',
    'SPEI_END_SR_STREAM', 'SGLexical', 'SpeechCategoryAppLexicons',
    'SGDSActiveWithAutoPause',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPEI_RESERVED6',
    'DISPID_SVGetAudioOutputs', 'DISPID_SRSClsidEngine',
    'DISPID_SPIRetainedSizeBytes',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SRGRecoContext',
    'SPEI_REQUEST_UI', 'SECFEmulateResult', 'STSF_LocalAppData',
    'DISPID_SOTRemove', 'SAFTADPCM_22kHzMono',
    'ISpeechGrammarRuleState', 'ISpeechRecognizerStatus',
    'SVEPhoneme', 'SpeechTokenValueCLSID', 'SREAudioLevel',
    'SPLO_DYNAMIC', 'SpeechCategoryAudioOut',
    'DISPID_SpeechGrammarRules', 'SpeechInterference',
    'DISPID_SFSClose', 'SPEI_RESERVED2', 'DISPID_SOTsItem',
    'ISpStreamFormatConverter', 'DISPID_SAFSetWaveFormatEx',
    'DISPIDSPTSI', 'ISpeechPhoneConverter', 'SpeechVisemeType',
    'SPWAVEFORMATTYPE', 'SAFTText', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SMSALineId', 'SpMemoryStream', 'SPCT_SLEEP',
    'SPGS_EXCLUSIVE', 'DISPID_SpeechPhraseReplacement',
    'eLEXTYPE_RESERVED7', 'eLEXTYPE_PRIVATE10', 'ISpeechMemoryStream',
    'STSF_AppData', 'SWPUnknownWordUnpronounceable',
    'DISPID_SDKGetStringValue', 'SPBO_PAUSE', 'SAFT32kHz8BitStereo',
    'DISPID_SVVolume', 'SPDKL_CurrentConfig', 'DISPID_SVAudioOutput',
    'DISPID_SGRClear', 'DISPID_SBSRead', 'DISPID_SABufferInfo',
    'SPEVENT', 'DISPID_SOTs_NewEnum', 'SRSInactiveWithPurge',
    'SBOPause', 'SVSFParseAutodetect', 'ISpeechRecoContext',
    'SAFT44kHz8BitStereo', 'DISPID_SLPs_NewEnum',
    'SPEI_FALSE_RECOGNITION', 'SpCompressedLexicon',
    'SpeechRecognizerState', 'DISPID_SRCEInterference', 'SITooSlow',
    'SAFT44kHz16BitMono', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SPCIdToPhone', 'DISPID_SpeechPhraseAlternate',
    'SP_VISEME_19', 'SpeechStreamSeekPositionType',
    'ISpeechRecognizer', 'SECFIgnoreCase', 'SAFT11kHz8BitMono',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SLPSymbolic',
    'DISPID_SGRSTsItem', 'SpeechVoiceSkipTypeSentence',
    'SSFMOpenForRead', 'SpNotifyTranslator', 'SpMMAudioEnum',
    'DISPID_SAFGetWaveFormatEx', 'SGLexicalNoSpecialChars',
    'SVSFParseMask', 'eLEXTYPE_PRIVATE3', 'SPEI_MAX_TTS',
    'SpeechDataKeyLocation', 'SRTSMLTimeout', 'SPDKL_DefaultLocation',
    'SAFT8kHz16BitStereo', 'DISPID_SPIElements', 'SVSFNLPSpeakPunc',
    'DISPID_SPPFirstElement', 'SDTAudio',
    'SWPUnknownWordPronounceable', 'ISpObjectTokenCategory',
    'ISpeechLexiconPronunciation', 'SDTPronunciation',
    'DISPID_SFSOpen', 'DISPID_SpeechVoice',
    'DISPID_SPEAudioTimeOffset', 'SPPHRASEELEMENT',
    'ISpeechLexiconWords', 'SPPS_RESERVED1', 'DISPID_SVStatus',
    'DISPID_SOTGetDescription', 'SpeechVoiceSpeakFlags',
    'DISPID_SRCRecognizer', 'SPCS_ENABLED', 'SP_VISEME_13',
    'SPINTERFERENCE_NOISE', 'SpLexicon', 'SVP_7', 'SVP_21',
    'ISpRecoResult', 'DISPID_SRRGetXMLResult', 'SPBO_NONE',
    'ISpeechLexiconWord', 'ISpShortcut',
    'ISpeechTextSelectionInformation', 'DISPID_SRGetPropertyNumber',
    'SPCT_SUB_DICTATION', 'SAFTCCITT_ALaw_11kHzMono',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SDKGetlongValue',
    'SpeechTokenKeyAttributes', 'DISPID_SOTMatchesAttributes',
    'DISPID_SRCRequestedUIType', 'SVP_6', 'SAFT32kHz8BitMono',
    'SPRECOCONTEXTSTATUS', 'DISPID_SpeechPhraseElement',
    'SpeechTokenContext', 'DISPID_SVEWord', 'SAFT16kHz8BitMono',
    'DISPID_SpeechPhraseProperty', 'SPSModifier',
    'SPINTERFERENCE_TOOLOUD', 'SVP_14',
    'DISPID_SOTGetStorageFileName', 'SPEI_START_INPUT_STREAM',
    'DISPID_SGRSRule', 'SRTAutopause', 'DISPID_SLWLangId',
    'DISPID_SRCEPropertyStringChange', 'eLEXTYPE_LETTERTOSOUND',
    'SPEI_SR_BOOKMARK', 'SpeechMicTraining',
    'DISPID_SGRsCommitAndSave', 'DISPID_SGRAttributes', 'SVP_9',
    'DISPID_SRCEStartStream', 'SBONone', 'SpVoice',
    'DISPID_SPRuleChildren', 'ISpeechPhraseRules',
    'DISPID_SDKSetLongValue', 'DISPID_SVGetProfiles', 'SPPHRASERULE',
    'SVEStartInputStream', 'SRTStandard', 'DISPID_SVSInputWordLength',
    'SpeechEmulationCompareFlags', 'DISPID_SRCEFalseRecognition',
    'DISPID_SVIsUISupported', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SDKEnumValues', '__MIDL_IWinTypes_0009', 'SREStreamEnd',
    'SDKLLocalMachine', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SLWs_NewEnum', 'SAFT12kHz8BitMono', 'SECNormalConfidence',
    'SAFT11kHz8BitStereo', 'DISPID_SOTId', 'DISPID_SMSSetData',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SRCEEnginePrivate',
    'DISPID_SAFGuid', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SVSyncronousSpeakTimeout', 'Speech_Default_Weight',
    'SPEI_MIN_TTS', 'DISPID_SPEs_NewEnum', 'SPBO_TIME_UNITS',
    'ISpRecoGrammar', 'Speech_Max_Word_Length', 'ISpRecoGrammar2',
    'DISPID_SGRSAddWordTransition',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SpeechVoiceEvents',
    'SPPS_Modifier', 'DISPID_SPIProperties', 'SPPS_RESERVED4',
    'SPPHRASEPROPERTY', 'DISPID_SPRsCount', 'eLEXTYPE_PRIVATE9',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SGRSTWeight',
    'DISPID_SRAudioInputStream', 'DISPID_SREmulateRecognition',
    'SPSHORTCUTPAIR', 'SpPhraseInfoBuilder', 'ISpStreamFormat',
    'SP_VISEME_4', 'DISPID_SVPriority', 'SPAUDIOSTATE',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SGRSTRule', 'SPRST_ACTIVE',
    'ISpeechPhraseRule', 'DISPID_SOTsCount', 'SRAONone',
    'STCRemoteServer', 'SAFT22kHz16BitMono',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SVGetVoices',
    'SPEI_START_SR_STREAM', 'DISPID_SGRSTPropertyId',
    'DISPID_SRIsShared', 'DISPID_SRCERecognitionForOtherContext',
    'eLEXTYPE_RESERVED4', 'eLEXTYPE_RESERVED9',
    'DISPID_SpeechPhraseElements', 'DISPID_SPRuleNumberOfElements',
    'SDTRule', 'SAFTCCITT_ALaw_8kHzStereo',
    'ISpeechPhraseReplacement', 'DISPIDSPTSI_SelectionOffset',
    'SAFT24kHz8BitStereo', 'SDTProperty', 'DISPID_SVEVoiceChange',
    'DISPID_SpeechPhraseAlternates', 'ISpeechRecoResultDispatch',
    'ISpeechLexicon', 'DISPID_SVSCurrentStreamNumber',
    'SSTTDictation', 'ISpeechXMLRecoResult', 'SAFT24kHz8BitMono',
    'SAFTADPCM_11kHzStereo', 'DISPID_SPEsCount', 'SPAS_CLOSED',
    'DISPID_SRGReset', 'DISPIDSPTSI_ActiveOffset', 'ISpRecognizer2',
    'tagSTATSTG', 'DISPID_SOTCGetDataKey',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SVSVisemeId',
    'IStream', 'ISpPhoneticAlphabetSelection',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SRRSpeakAudio',
    'SVPAlert', 'SPEI_SR_AUDIO_LEVEL', 'SAFTCCITT_uLaw_11kHzStereo',
    'SpeechCategoryRecoProfiles', 'SP_VISEME_0',
    'SGDSActiveUserDelimited', 'DISPID_SpeechCustomStream',
    'SPFM_OPEN_READWRITE', 'DISPID_SCSBaseStream',
    'SpeechRecoContextState', 'DISPID_SPAsCount',
    'DISPID_SVEBookmark', 'DISPID_SPELexicalForm', 'DISPID_SAVolume',
    'SITooLoud', 'eLEXTYPE_RESERVED10', 'DISPID_SGRsAdd',
    'SVSFIsNotXML', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SPEI_VOICE_CHANGE', 'SVP_10', 'SAFTGSM610_22kHzMono',
    'SDTAlternates', 'SPEI_PHONEME', 'eLEXTYPE_PRIVATE8',
    'SPSEMANTICERRORINFO', 'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SRGId',
    'DISPID_SGRId', 'ISpeechPhraseElement', 'SRSActiveAlways',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SAFTADPCM_44kHzStereo',
    'DISPID_SPEAudioSizeBytes', 'ISpLexicon', 'ISpeechRecoGrammar',
    'ISpNotifyTranslator', 'STCInprocHandler', 'SAFT48kHz8BitMono',
    'SPINTERFERENCE_TOOQUIET', 'SAFT48kHz16BitStereo',
    'SVEWordBoundary', 'SSSPTRelativeToEnd',
    'ISpeechPhraseReplacements', 'SPSHT_NotOverriden', 'SP_VISEME_15',
    'ISpeechVoiceStatus', 'ISpeechObjectTokens', 'ISpeechVoice',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SWFEChannels',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SRRTimes',
    'SPWT_PRONUNCIATION', 'SPPS_Noncontent',
    'DISPID_SRGSetWordSequenceData', 'SPSTREAMFORMATTYPE',
    'DISPID_SpeechLexiconWord', 'SDTLexicalForm',
    'DISPID_SGRs_NewEnum', 'SREAdaptation', 'SPEI_ADAPTATION',
    'SpeechEngineConfidence', 'SPEI_MIN_SR',
    'Speech_StreamPos_RealTime', 'DISPID_SPPValue',
    'SpeechGrammarTagWildcard', 'SPDKL_CurrentUser',
    'SpeechEngineProperties', 'SWTAdded', 'eLEXTYPE_PRIVATE18',
    'SpSharedRecoContext', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SVP_0', 'DISPID_SASState', 'DISPID_SLGetPronunciations',
    'SPCONTEXTSTATE', 'DISPID_SpeechAudioFormat',
    'SpeechVoicePriority', 'SPEI_RESERVED5', 'DISPID_SRGetFormat',
    'DISPID_SAFType', 'ISpeechGrammarRules', 'SAFTGSM610_11kHzMono',
    'DISPID_SDKDeleteKey', 'SPWORDLIST', 'SVEVoiceChange',
    'SLOStatic', 'SVF_Emphasis', 'SPDATAKEYLOCATION',
    'DISPID_SRAudioInput', 'DISPID_SRCEAudioLevel',
    'SpeechCategoryRecognizers', 'eLEXTYPE_PRIVATE15',
    'SPFM_NUM_MODES', 'SPSNoun', 'SPGS_DISABLED', 'SINoSignal',
    'SP_VISEME_8', 'SpeechTokenIdUserLexicon', 'SpNullPhoneConverter',
    'SPAUDIOOPTIONS', 'SPRECOSTATE', 'SPEI_SENTENCE_BOUNDARY',
    'SAFTGSM610_44kHzMono', 'ISpMMSysAudio',
    'DISPID_SpeechGrammarRule', '_ISpeechRecoContextEvents',
    'SAFTADPCM_8kHzStereo', 'DISPID_SpeechPhraseReplacements',
    'SGRSTTDictation', 'DISPID_SpeechGrammarRuleStateTransition',
    'SDA_One_Trailing_Space', 'SpeechGrammarState',
    'Speech_Max_Pron_Length', 'DISPID_SPACommit',
    'ISpeechPhraseAlternates', 'SPTEXTSELECTIONINFO',
    'DISPID_SGRSTPropertyValue', 'DISPID_SVVoice',
    'eWORDTYPE_DELETED', 'DISPID_SRCPause',
    'DISPID_SVSLastStreamNumberQueued', 'SpeechDiscardType',
    'DISPID_SpeechRecoContext', 'eLEXTYPE_PRIVATE7', 'SVP_17',
    'SpResourceManager', 'SAFT8kHz8BitStereo', 'SP_VISEME_5',
    'DISPID_SRGRules', 'SP_VISEME_12', 'DISPID_SWFEBitsPerSample',
    'eLEXTYPE_USER', 'SpeechAddRemoveWord', 'SREPropertyNumChange',
    'DISPID_SpeechPhraseProperties', 'DISPID_SGRsCommit',
    'DISPID_SPRDisplayAttributes', 'eLEXTYPE_RESERVED8',
    'SPVPRI_ALERT', 'DISPID_SLPLangId', 'ISpRecoContext',
    'SITooQuiet', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SpeechRecognizerStatus', 'STCInprocServer',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SVSpeakStream',
    'SLTApp', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SPPConfidence', 'DISPID_SMSAMMHandle',
    'SPINTERFERENCE_NONE', 'DISPID_SRGDictationSetState',
    'DISPID_SVResume', 'IEnumString', 'ISpPhrase', 'SRSEDone',
    'eLEXTYPE_PRIVATE11', 'IEnumSpObjectTokens',
    'DISPID_SLGetGenerationChange', 'SSSPTRelativeToStart',
    'SPPS_SuppressWord', 'SPEI_SR_RETAINEDAUDIO', 'DISPIDSPRG',
    'SPPS_NotOverriden', 'SPPS_Function', 'SAFTDefault',
    'DISPID_SLRemovePronunciation', 'SPAO_RETAIN_AUDIO',
    'eLEXTYPE_RESERVED6', 'DISPID_SPRulesItem', 'SSTTTextBuffer',
    'DISPID_SPRuleConfidence', 'SRARoot', 'SPFM_OPEN_READONLY',
    'DISPID_SWFEExtraData', 'SREPhraseStart', 'DISPID_SOTDataKey',
    'SpFileStream', 'SpeechGrammarTagUnlimitedDictation',
    'SPEI_RESERVED3', 'DISPID_SLWsCount', 'SPSEMANTICFORMAT',
    'SP_VISEME_18', 'ISpGrammarBuilder', 'SPRST_NUM_STATES',
    'DISPID_SVSkip', 'eLEXTYPE_PRIVATE13', 'DISPID_SPRuleId',
    'ISpeechAudio', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SRCEPhraseStart', 'DISPID_SPEDisplayAttributes',
    'SVEBookmark', 'DISPID_SRCAudioInInterferenceStatus',
    'eLEXTYPE_PRIVATE17', 'SDKLCurrentUser', 'DISPID_SABIEventBias',
    'SLTUser', 'DISPID_SRCESoundEnd', 'SPRS_ACTIVE',
    'DISPID_SpeechPhraseRule', 'SAFT44kHz16BitStereo',
    'SpeechPropertyNormalConfidenceThreshold',
    'SpeechRecoProfileProperties', 'SPSHORTCUTPAIRLIST', 'SGRSTTRule',
    'ISpeechDataKey', 'SAFT24kHz16BitStereo', 'ISpRecognizer3',
    'DISPID_SPPParent', 'DISPID_SpeechPhoneConverter',
    'SPEI_UNDEFINED', 'SPWORD', 'DISPID_SVSLastBookmarkId',
    'ISpXMLRecoResult', 'DISPID_SABufferNotifySize',
    'SSFMCreateForWrite', 'SpeechRuleState', 'SGDSInactive',
    'DISPID_SRCEEndStream', 'ISpeechWaveFormatEx',
    'ISpResourceManager', 'SpeechVisemeFeature',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SRGetRecognizers',
    'SPPHRASEREPLACEMENT', 'SRTReSent', 'DISPID_SLWType',
    'DISPID_SPPName', 'DISPID_SOTCId', 'SPPS_LMA', 'SREPrivate',
    'DISPID_SPIGetText', 'SpeechTokenShellFolder',
    'DISPID_SVDisplayUI', 'SVP_2', 'SVSFPersistXML', 'ISpRecognizer',
    'SpeechRetainedAudioOptions', 'DISPID_SRGIsPronounceable',
    'DISPID_SpeechFileStream', 'SAFTCCITT_ALaw_44kHzMono',
    'SVSFUnusedFlags', 'DISPID_SPPsCount', 'DISPID_SPIGrammarId',
    'SPWT_DISPLAY', 'DISPID_SRRTTickCount', 'DISPID_SpeechDataKey',
    'SP_VISEME_16', 'DISPID_SRStatus', 'DISPID_SOTCreateInstance',
    'ISpPhoneConverter', 'SPWORDPRONOUNCEABLE',
    'DISPID_SpeechMemoryStream', 'DISPID_SPERequiredConfidence',
    'SpeechDisplayAttributes', 'SPBO_AHEAD', 'SECFDefault',
    'SPXMLRESULTOPTIONS', 'DISPID_SGRSTText', 'SPAO_NONE',
    'SPRULESTATE', 'DISPID_SWFEFormatTag', 'DISPID_SpeechRecoResult2',
    'SpeechGrammarWordType', 'SVP_19', 'SRSInactive',
    'DISPID_SRCERequestUI', 'SGRSTTWildcard', 'SVEAudioLevel',
    'ISpEventSink', 'SVSFPurgeBeforeSpeak', 'DISPID_SVPause',
    'SPAS_PAUSE', 'SREHypothesis', 'SpeechFormatType', 'SREBookmark',
    'DISPID_SPCLangId', 'SPLOADOPTIONS', 'SPEVENTENUM',
    'DISPID_SDKSetBinaryValue', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SRCRetainedAudioFormat', 'SPPARTOFSPEECH',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SLPType',
    'SDA_Consume_Leading_Spaces', 'ISpVoice',
    'DISPID_SpeechRecognizer', 'SGRSTTEpsilon', 'SAFT48kHz8BitStereo',
    'SAFT32kHz16BitStereo', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SPRuleFirstElement', 'SpeechTokenKeyFiles',
    'SSFMOpenReadWrite', 'SpUnCompressedLexicon',
    'DISPID_SOTDisplayUI', 'SPCT_SUB_COMMAND',
    'SpeechWordPronounceable', 'DISPID_SRGCmdLoadFromFile',
    'SpeechRecognitionType', 'SAFT16kHz16BitStereo',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SGRSTsCount', 'SPPS_Noun',
    'SpeechAudioFormatType', 'SpObjectToken', 'SPVOICESTATUS',
    'SPGRAMMARSTATE', 'SAFTADPCM_8kHzMono', 'SVP_15',
    'DISPID_SVEEnginePrivate', 'SpeechRegistryUserRoot',
    'SpeechAudioVolume', 'DISPID_SPPsItem', 'DISPID_SLWsItem',
    'DISPID_SPIAudioStreamPosition'
]

_check_version('1.2.0', 1700054821.150877)
